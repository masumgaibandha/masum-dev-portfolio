...
const Header = () => {
    return (
        <div className='w-11/12 mx-auto max-w-3xl text-center h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <h3 className='flex items-center gap-2 text-xl md:text-2xl mb-3 font-Ovo'>Hi! I'm Abdullah Al Masum <Image src={assets.hand_icon} alt='' className='w-6' /></h3>
            <h1 className='text-3xl sm:text-6xl lg:text-[66px] font-Ovo'>frontend web developer</h1>
            <p className='max-w-2xl mx-auto font-Ovo'>
                I am a frontend developer with 5 years of experience in Multiple companies. 
            </p>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                <a href="/sample-resume.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>My resume 
